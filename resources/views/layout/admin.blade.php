            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="{{route('listobat160419077.index')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Medicine</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('ShowObatBatuk')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Obat Batuk</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('ShowLowestToHighestPrice')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Category Ordered by Price</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('ShowHighestStock')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Highest Stock Medicine</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
